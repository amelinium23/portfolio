...
export const TechnologiesUse = () => {
  return (
    <>
      <Container style={{ marginTop: "0.8vh" }}>
        <h5 style={{ borderBottom: "1px solid #464646" }}>
      ...
      <Container>
        <p>
          IDEs and tools of my choice. <br /> I created a theme for Visual
          Studio Code! Simply click the VSC logo to check it out.
        </p>
        <Container className="frameworkContainer">
          <a
