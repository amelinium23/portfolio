        ...
        <Container>
            ...
            <Container style={containerStyle}>
                <Col md={8} className="aboutMeDescription">
                    ...
                    <p>I&apos;m student of Computer Science at TUL. I&apos;m fullstack developer based in Lodz, Poland. Currently working at TomTom as an intern fullstack software developer.</p>
